"""The below script calculates point coverage with Planet SkySat satellites 
    over the CONUS region."""
...
from dshield_format_converter import ( # pylint: disable=wrong-import-position
    ...
    write_dshield_format_of_point_coverage_results,
)
...
point_coverage_calculator_results = results.get(
...
exec_start_time = time.time()
point_coverage_calculator_results_serializable = JsonSerializer.to_serializable(
    point_coverage_calculator_results
)
elapsed_time = time.time() - exec_start_time
print(
    f"elapsed time for point_coverage_calculator_results_serializable is {elapsed_time}"
)

exec_start_time = time.time()
epoch_ephemeris_seconds = mission.start_time.to_spice_ephemeris_time()
write_dshield_format_of_point_coverage_results(
    point_coverage_calculator_results_serializable,
    results_dir,
    epoch,
